...
export default function Header() {
    ...
    return (
      <>
        ...
        <CartPopup show={showCart} onClose={() => _setShowCart(!showCart)} />
        <header
          id="header"
        ...
        >
            ...
            <div className="row">
                ...
                <div className="logo">
                  <a href="index.html">
                    <Img
                      ...
                      height="200"
                    />
                    <span className="logo-txt d-none">Optimal</span>
                  </a>
                </div>
              </div>
              <div className="col-1 col-sm-1 col-md-1 col-lg-7 align-self-center d-menu-col">
                <nav className="grid__item" id="AccessibleNav">
                  <ul id="siteNav" className="site-nav medium left hidearrow">
                    <li className="lvl1 parent megamenu">
                      <Link href={"/"}>
                        <a href="#;">
                          Home <i className="an an-angle-down-l"></i>
                        </a>
                      </Link>
                    </li>
                    <li className="lvl1 parent megamenu">
                      <Link href={`/about`}>
                        <a >
                          About <i className="an an-angle-down-l"></i>
                        </a>
                      </Link>
                    </li>
                  </ul>
              ...
              <div className="col-6 col-sm-6 col-md-6 col-lg-3 align-self-center icons-col d-flex justify-content-end">
                ...
                >
                  ...
                  <span className="text d-none d-lg-flex">Search</span>
                </div>
                <div className="user-link iconset">
                  <i className="icon an an-user d-block d-lg-none"></i>
                  <span className="text d-none d-lg-flex">My Account</span>
                </div>
                <div
          ...
          <div
            id="search-popup"
            className={`search-drawer ${showSearch && "active"} shadow-lg`}
          >
            <div className="container">
              <span
                ...
                <div className="control">
                  <div className="searchField">
                    <div className="search-category">
                      ...
                      >
                        <option value="00" label="All Categories" selected>
                          All Categories
                        </option>
