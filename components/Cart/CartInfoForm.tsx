...
export default function CartInfoForm({}: Props) {
  return (
    <div className="cart_info">
      <div id="shipping-calculator" className="mb-4 cart-col">
        <h5>Get shipping estimates</h5>
        <form className="estimate-form pt-1" action="#" method="post">
          ...
          <div className="actionRow">
            <input
              type="button"
              className="btn rounded get-rates w-100"
              value="Calculate shipping"
            />
          </div>
        </form>
      </div>
      <div className="cart-note mb-4 cart-col">
        <h5>Add a note to your order</h5>
        <textarea
          name="note"
          id="cart-note"
          className="form-control cart-note__input"
          rows={3}
          required
        ></textarea>
      </div>
      <div className="cart-order_detail cart-col">
        ...
        <p className="cart__shipping m-0">
          Shipping &amp; taxes calculated at checkout
        </p>
        <p className="cart__shipping pt-0 m-0 fst-normal freeShipclaim">
          <i className="me-1 align-middle icon an an-truck-l"></i>
          <b>FREE SHIPPING</b> ELIGIBLE
        </p>
        <div className="customCheckbox cart_tearm">
          <input type="checkbox" value="allen-vela" id="cart_tearm" />
          <label htmlFor="cart_tearm">
