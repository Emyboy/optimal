                ...
                <div className="product-sticky-style">
                    ...
                    <div className="zoompro-wrap product-zoom-right w-100 p-0">
                      ...
                      <div className="product-buttons">
                        ...
                        >
                          ...
                          <span className="tooltip-label">Watch Video</span>
                        </a>
                        <a href="#" className="btn rounded-0 prlightbox">
                          <i className="icon an an-expand-l-arrows"></i>
                          <span className="tooltip-label">Zoom Image</span>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="d-flex">
                      {[1, 1, 1, 1, 1, 1, 11, 1, 1, 1, 1, 1, 3].map(
                        (val, i) => {
                          return (
                            <img
                              key={`thumb-${i}`}
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                <div className="product-single__meta">
                    ...
                    >
                      <span className="ht-count days">
                        <span className="count-inner">
                          <span className="time-count">860</span>{" "}
                          <span>Days</span>
                        </span>
                      </span>{" "}
                      <span className="ht-count hour">
                        <span className="count-inner">
                          <span className="time-count">0</span> <span>HR</span>
                        </span>
                      </span>{" "}
                      ...
                      <span className="ht-count second">
                        <span className="count-inner">
                          <span className="time-count">41</span> <span>Sc</span>
                        </span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="product-review mb-2">
                    <a className="reviewLink d-flex-center" href="#reviews">
                      ...
                      <span className="spr-badge-caption ms-2">16 Reviews</span>
                    </a>
                  </div>
                  ...
                  <div className="product-info">
                    ...
                    <p className="product-sku">
                      SKU: <span className="variant-sku">1416PT-1</span>
                    </p>
                  </div>
                  ...
                  <div className="product-single__price pb-1">
                    ...
                    <span className="product-price__sale--single">
                      <span className="product-price-old-price">$200.00</span>
                      <span className="product-price__price product-price__sale">
                        $225.00
                      </span>
                      <span className="discount-badge">
                        <span className="devider me-2">|</span>
                        <span>Save: </span>
                  ...
                  >
                    ...
                    <p className="m-0">
                      <strong className="items">8</strong> Sold in last{" "}
                      <strong className="time">14</strong> hours
                    </p>
                    <p id="quantity_message" className="ms-2 ps-2 border-start">
                      Hurry! Only <span className="items fw-bold">4</span> left
                      in stock.
                    </p>
                  </div>
                </div>
                ...
                <div className="social-sharing d-flex-center mb-3">
                  ...
                  >
                    ...
                    <span className="share-title d-none">Linkedin</span>
                  </a>
                  <a
                    href="#"
                ...
                <div className="freeShipMsg" data-price="199">
                  <i className="icon an an-truck" aria-hidden="true"></i>
                  SPENT{" "}
                ...
                <div className="userViewMsg" data-user="20" data-time="11000">
                  <i className="icon an an-eye-r" aria-hidden="true"></i>
                  <strong className="uersView">12</strong> People are Looking
                  for this Product
                </div>

                <div className="tabs-listing mt-2 mt-md-5">
                  <div className="tab-container">
                    <h3 className="tabs-ac-style active">Description</h3>
                    <div
                      id="description"
          ...
          <div className="container">
            <div className="row">
              <div className="section-header col-12">
                <h2 className="text-transform-none">You May Also Like</h2>
              </div>
            </div>
